            ...
            <div class="col-md-3" v-for="course in courses">
                <div class="thumbnail search-thumbnail">
                    ...
                    <div class="caption">
                        ...
                        <div>
                                <img  v-show="!course.image" class="pull-left" src="/static/image/profile-pic.jpg" />
                                <img  v-show="course.image" clclass="pull-left" v-bind:src="course.image" />
                    ...
                    <div class="modal-body">
                        <form class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input v-model="sort.oldSort"   disabled class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
    ...
    export default {
        ...
        methods: {
            ...
            add() {
                let _this = this;
                _this.course = {
                    sort:_this.$refs.pagination.total+1//初始化排序 当前总条数加1
                };
            ...
            save() {
                let _this = this;
               let  categorysCheck  =_this.tree.getChangeCheckedNodes();
                if(Tool.isEmpty(categorysCheck)){
                    Toast.warning("请选择课程分类");
                    return;
                }
               this.course.categoryDtos = categorysCheck;
            ...
            allTeacher() {
                let _this = this;
                _this.$ajax.post(process.env.VUE_APP_SERVER + '/business/admin/teacher/allTeacher', {
                }).then((response)=>{
                    let resp = response.data;
